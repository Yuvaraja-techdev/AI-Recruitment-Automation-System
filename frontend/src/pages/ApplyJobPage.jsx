        ...
        <main className="flex-grow max-w-6xl w-full mx-auto px-4 py-8 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* Scoring & Qualification Section */}
              <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm space-y-6">
                <div>
                  <h3 className="text-xs font-black text-slate-800 uppercase tracking-wider mb-1 font-display flex items-center gap-2">
                    <Award className="w-4.5 h-4.5 text-indigo-650" />
                    Scoring & Qualification
                  </h3>
                  <p className="text-[10px] text-slate-400 font-medium">Scoring breakdown, evaluation methodology, and passing criteria</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Left Column: Assessment Scoring */}
                  <div className="space-y-4">
                    <h4 className="text-[11px] font-bold text-slate-700 uppercase tracking-wider flex items-center gap-1.5 border-b border-slate-100 pb-2">
                  ...
                  {/* Right Column: Final Evaluation & Qualifying Criteria */}
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <ul className="space-y-2 text-[10px] text-slate-550 leading-relaxed font-semibold">
                        <li className="flex items-start gap-1.5">
                          <span className="text-indigo-650 font-bold mt-0.5">•</span>
                          <span>Your final score is calculated by summing the marks obtained in all questions.</span>
                        </li>
                        <li className="flex items-start gap-1.5">
                          <span className="text-indigo-650 font-bold mt-0.5">•</span>
                          <span>Maximum Score = Sum of the maximum marks of all questions in the assessment.</span>
                        </li>
                        <li className="flex items-start gap-1.5">
                          <span className="text-indigo-650 font-bold mt-0.5">•</span>
                          <span>Percentage = <span className="font-bold text-slate-800 dark:text-slate-205">(Obtained Score ÷ Maximum Score) × 100</span></span>
                        </li>
                        <li className="flex items-start gap-1.5">
                          <span className="text-indigo-650 font-bold mt-0.5">•</span>
                          <span>Percentage is calculated automatically after evaluation.</span>
                        </li>
                      </ul>
                    </div>
                  </div>
